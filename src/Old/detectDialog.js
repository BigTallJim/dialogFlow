...
function detectTextIntent(projectId2, sessionId2, queries2, languageCode2) {
...
//   const languageCode = 'en';
  ...
  //console.log(projectId, sessionId, queries, languageCode)
  let projectId = 'pizzabottest-oepuli';
  let sessionId = '84a11f20-5a40-11ea-a6c9-d386f4c62d30';
  let queries = [ 'order pizza' ];
  let languageCode = 'en';
